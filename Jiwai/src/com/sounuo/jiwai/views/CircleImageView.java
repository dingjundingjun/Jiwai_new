...
//        if (mSetupPending) {
        Debug.d(TAG," reflash mSetupPending()");
            setup();
            mSetupPending = false;
//        }
    }
    ...
    public void setIsNeedUpload(boolean isNeed){
    	this.isNeedUpload = isNeed;
    }
